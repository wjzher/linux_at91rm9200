...
static void __init dk_init_irq(void)
{
	...
	at91_gpio_irq_setup(PQFP_GPIO_BANKS);//BGA_GPIO_BANKS
}
...
{
	int serial[AT91C_NR_UART] = DK_UART_MAP;
	int i;

	at91rm9200_map_io();
	
	/* Initialize clocks */
	at91_main_clock = 179712000;		/* from 18.432 MHz crystal (18432000 / 4 * 39) */
	at91_master_clock = 59904000;		/* peripheral clock (at91_main_clock / 3) */
	at91_pllb_clock = 0x1048be0e;		/* (18.432 / 14 * 73) /2 = 47.9714  */
