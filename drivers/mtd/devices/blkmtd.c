...
#warning "MTD CHECK: MODULE NOT DEFINED!"

static int __init param_blkmtd_device(char *str)
{
	int i;
    printk("set blkmtd device name\n");
...
#if 0
        param_blkmtd_device("blkmtd_device=");
        param_blkmtd_erasesz("blkmtd_erasesz=");
        param_blkmtd_ro("blkmtd_ro=");
        param_blkmtd_sync("blkmtd_sync=");
#endif
