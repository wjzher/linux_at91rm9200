...
#ifdef CONFIG_BD
//#if defined EDUREQ
//extern int recv_le_bd(term_ram *ptrm, int allow, int flag);
//#elif defined (S_BID) || defined (USRCFG1) || defined (CONFIG_CNTVER)
//extern int recv_le_bd(term_ram *ptrm, int allow, int itm);
//#else
//extern int recv_le_bd(term_ram *ptrm, int allow);
//#endif/* S_BID */
#endif
#ifdef CONFIG_CNTVER
