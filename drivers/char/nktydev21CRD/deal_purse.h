...
extern int purse_recv_leid(term_ram *ptrm, int allow, unsigned char *tm);//2013.7.1
...
int purse_recv_leid2(term_ram *ptrm, int allow, unsigned char *tm);//2013.7.1
