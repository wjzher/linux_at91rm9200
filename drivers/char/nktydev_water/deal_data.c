...
#endif
{
	...
	//	printk("%ld: not find\n", cardno);//2013.9.22
		...
		//	feature = 4;
		//}
	//	printk("%ld: acc feature is %x\n", cardno, pacc->feature);//2013.9.22
...
//	printk("%ld: acc end feature is %x\n", cardno, pacc->feature);//2013.9.22
#ifdef CONFIG_QH_WATER
...
#endif
#if 0 //modified by duyy,2012.11.12
/*
...
#if 0 //modified by duyy,2012.11.13
// 增加双校验标志
...
int recv_le_id4(term_ram *ptrm, int allow, int xor, int itm)
{
	...
	//tmoney = imy;//modified by duyy,2012.11.12
	//_type = ptrm->pterm->power_id & 0x3;//modified by duyy,2012.11.12
#ifdef USRDBG
	//printk("tmoney = %d, _type = %d\n", tmoney, _type);//modified by duyy,2012.11.12
#endif
	// search id
...
///////////////////////////////////////////////////////////////////////////////////
		...
		//if (!tmoney) {//modified by duyy,2012.11.12
		//	feature = 1;	// 超过限制
		//}
#endif
		//acc = pacc->acc_num;
