...
#define RECVLEIDGDZJ 0x1E	// 实现0元0折扣,write by duyy, 2014.1.16
...
typedef struct __terminal {			// 35-byte
	unsigned char term_type;		// type of terminal,分为消费机和出纳机
...
typedef struct __acc_ram {		// 应用程序和内核共用
	...
	char listlimit;//modified by duyy, 2013.1.7 //三辊闸消费次数统计值，write by duyy, 2013.4.24
	char csulimit;//modified by duyy, 2013.1.7 //消费终端消费次数统计值，write by duyy, 2013.4.24
#endif
